...
from tests.integration.cognition.test_persona import _bounded_auto_config
from tests.integration.console.test_console_authentication import auth as auth_fixture
from tests.integration.console.test_console_persona_commands import publish, ready, state_evidence
