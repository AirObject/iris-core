...
def test_each_content_type_uses_core_forget_in_required_mode(
    ...
    from tests.integration.console.test_console_artifact_http import payload as artifact_payload
    from tests.integration.console.test_console_claim_http import create_payload, source
    from tests.integration.console.test_console_episode_http import payload as episode_payload
    from tests.integration.console.test_console_relation_http import payload as relation_payload
...
def test_blob_forget_and_restoration_preserve_erasure_semantics(
    ...
    from iris_memory_core.storage.runtime import SQLiteRuntime, sqlite_runtime_version
    from iris_memory_core.storage.uow import Store
    from tests.integration.console.test_console_artifact_upload import files, metadata, upload
