...
| 尚未决定 | 空文本、部分理解、普通失败后的新事件处理、上传限制与GC保护参数待固定。 [产品剩余契约](../product/decisions-and-delivery.md#section-22)；[工程冻结点](../architecture/implementation-options.md#source-line-1216)；[当前任务与阻塞](../work/CURRENT_TASK.md) |
