...
| 尚未决定 | 输入契约、无外部事件ID时的幂等键、鉴权与错误格式尚待固定。 [产品剩余契约](../product/decisions-and-delivery.md#section-22)；[工程冻结点](../architecture/implementation-options.md#source-line-1216)；[当前任务与阻塞](../work/CURRENT_TASK.md) |
