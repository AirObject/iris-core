...
| 公开能力与依赖 | 本模块“建议端口”保留完整模块方向；本次[基础服务与模拟适配器契约](../architecture/provider.md#provider-foundation-contract)细化有限交付，已由主会话按用户授权审查批准；[统一依赖与启动边界](../architecture/ownership.md#source-line-267) |
