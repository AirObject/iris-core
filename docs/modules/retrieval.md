...
| 尚未决定 | 检索后端与中文方案、一秒语义降级策略、反馈凭据有效期和空间迁移覆盖条件待批准。 [产品剩余契约](../product/decisions-and-delivery.md#section-22)；[工程冻结点](../architecture/implementation-options.md#source-line-1216)；[当前任务与阻塞](../work/CURRENT_TASK.md) |
