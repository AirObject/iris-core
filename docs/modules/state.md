...
| 尚未决定 | 时间格式、活动结束、子状态时间、缺失时间与陈旧阈值待接口契约。 [产品剩余契约](../product/decisions-and-delivery.md#section-22)；[工程冻结点](../architecture/implementation-options.md#source-line-1216)；[当前任务与阻塞](../work/CURRENT_TASK.md) |
