...
本模块日常认知的动作、工具与持久运行细化，见[集中契约](../architecture/daily-cognition-and-image-learning.md#reasoning)。
...
已批准细化：[稳定候选与真实所有者接入](../architecture/formal-memory-source-media.md#sources-candidates)、[新材料及容量核算](../architecture/formal-memory-source-media.md#capacity)；本次与后续认知职责的界限见[集中范围](../architecture/formal-memory-source-media.md#scope)。
...
| 工程验收定位 | [V06](../architecture/acceptance.md#v06)、[V07](../architecture/acceptance.md#v07)、[V09](../architecture/acceptance.md#v09)、[V30](../architecture/acceptance.md#v30)、[V40](../architecture/acceptance.md#v40)（验收要求；实际覆盖见[STATUS](../work/STATUS.md)） |
