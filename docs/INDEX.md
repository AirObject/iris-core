...
[正式记忆、完整来源与媒体持久化闭环](architecture/formal-memory-source-media.md)：五组推荐及四份所属补充已获用户批准，未采纳替代和范围外事项保持未批准；包含实际端口核对、对象与来源、媒体发布／复用／GC、容量核算、兼容和整体验收矩阵。配置、持久化、日志及Provider必要补充由正文链接导航；文档定稿、整阶段实现、自查、测试及范围内修复已授权；完成后停在监督技术审查，暂不提交。
