        ...
        try:
            ...
            if name in ('sources_insert', 'sources_references'):
                ...
                if values['body'] is not None:
                    logical = values['body']; header, _ = split_manifest(logical)
            ...
            for ordinal in range(len(member_digests(body))):
            ...
            return (MappingProxyType({**row, 'body': join_manifest(body, tuple(members))}),)
