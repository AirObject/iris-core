...
if TYPE_CHECKING:
    from .dream_resolution import DreamConfigurationCandidate
...
def candidate_values(candidate: DreamConfigurationCandidate) -> InitializationValues:
    ...
    catalog=dump({'version':7,'domains':[{'domain_id':d['domain_id'],'revision':1} for d in domains],
...
def candidate_inputs(candidate: DreamConfigurationCandidate,protected_directories:object) -> tuple[object,...]:
