"""Validate complete managed values without trial-package quota identities.
...
def validate_managed_values(foundation, text) -> None:
    ...
    if by_role['EMBEDDING_DOCUMENT']['account_id']!=by_role['EMBEDDING_QUERY']['account_id']:raise InvalidValue()
