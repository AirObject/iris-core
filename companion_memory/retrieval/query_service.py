...
class QueryService:
    ...
    def __init__(self, configuration: StoredInformationConfiguration | StoredTextConfiguration | StoredSemanticConfiguration | StoredCognitionConfiguration, runtime: ContentRuntimeService, management: ManagementAssembly,
        ...
        elif type(configuration) is StoredDailyConfiguration or (type(configuration) is StoredDreamConfiguration or type(configuration) is StoredManagedConfiguration):
        ...
        if ((type(configuration) is StoredSemanticConfiguration or type(configuration) is StoredDailyConfiguration or type(configuration) is StoredDreamConfiguration or type(configuration) is StoredManagedConfiguration))!=(type(semantic) is SemanticQuery):raise ValueError('Native semantic query assembly differs.')
