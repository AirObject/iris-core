...
class ObservationService:
    ...
    def _draft(access: AccessContext, record: dict[str, Any]) -> ObservationDraft:
        ...
        return ObservationDraft(
            ...
            context_kind=str(record.get("context_kind", "interaction")),
            source_thread_id=_optional_str(record, "source_thread_id", what=what),
            reply_to_source_event_id=_optional_str(record, "reply_to_source_event_id", what=what),
